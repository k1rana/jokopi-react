    ...
    <Fragment>
      <main>
        <div className="flex flex-col lg:flex-row">
          ...
          <section className="lg:w-1/2 px-4 py-7 lg:px-16 bg-main bg-cover bg-center bg-black/70 lg:bg-white lg:bg-none lg:text-black flex justify-center ">
            <div className="bg-white px-5 py-6 lg:p-0 rounded-xl">
              ...
              <section className="mt-16">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full text-white bg-tertiary focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-2xl text-lg p-3 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 shadow-xl lg:mb-20"
                  >
                    Sign up here
                  </button>
                </form>
