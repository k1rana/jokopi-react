...
function Cart() {
  ...
  const Main = (props) => {
    return (
      <main className="bg-cart bg-cover bg-center px-10 lg:px-22 py-10 space-y-3">
        ...
        <section className="flex flex-col md:flex-row lg:gap-16 gap-10">
            ...
            <section className="flex bg-white rounded-lg p-5 lg:p-7 flex-col w-full">
                  ...
                  return (
                    ...
                    >
                      ...
                      <aside className="flex-1">
                        <p>
                          IDR
                          {Number(list.total_price * list.count)
                            .toString()
                            .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}
                        </p>
                      </aside>
              ...
              <section className="flex flex-col w-full my-4">
                <div className="flex flex-row uppercase lg:text-lg">
                  ...
                  <p className="flex-1 lg:flex-none">
                    IDR{" "}
                    {cart
                      .reduce(
                        (acc, cur) => acc + cur.total_price * cur.count,
                        0
                      )
                      .toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}
                ...
                <div className="flex flex-row uppercase lg:text-lg">
                  ...
                  <p className="flex-1 lg:flex-none">IDR 20.000</p>
                </div>
                <div className="flex flex-row uppercase lg:text-lg">
                  <p className="flex-[2_2_0%]">Shipping</p>
                  <p className="flex-1 lg:flex-none">IDR 10.000</p>
                </div>
          ...
          <aside className="flex-1 flex flex-col gap-5">
            <section className="text-white text-2xl font-extrabold drop-shadow-lg text-center md:text-left relative">
              Address details
              <Link
                to="/profile"
                className="absolute text-lg right-0 top-1 hover:underline"
              >
                edit
              </Link>
            </section>
            <section className="bg-white rounded-xl  p-5 lg:p-7 space-y-2">
              ...
              <p className="">Hooh</p>
              <hr />
              <p className="">073523853829</p>
            </section>
            <section className="text-white text-2xl font-extrabold drop-shadow-lg text-center md:text-left relative mt-auto">
              Payment method
            </section>
            <section className="bg-white rounded-xl  p-5 lg:p-7 space-y-3">
              ...
              <div className="flex gap-2 items-center">
                <input
                  ...
                  onChange={onChangeForm}
                />
                <label htmlFor="paymentCod" className="flex items-center gap-2">
                  <svg
                    width="40"
                    height="40"
                    viewBox="0 0 40 40"
            ...
            <button className="bg-tertiary text-white p-4 font-bold rounded-lg">
              Confirm and Pay
            </button>
          </aside>
        </section>
